...
// 	"github.com/oikomi/FishChatServer2/server/logic/conf_discovery"
...
// func (accessServerRPCCli *AccessServerRPCCli) SyncMsg(ctx context.Context, sendNotifyReq *rpc.ASSendNotifyReq) (res *rpc.ASSendNotifyRes, err error) {
...
// 		if res, err = a.(ctx, sendNotifyReq); err != nil {
// 			glog.Error(err)
// 		}
// 	} else {
